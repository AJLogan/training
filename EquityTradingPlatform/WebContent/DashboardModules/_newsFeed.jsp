		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<span
						class="glyphicon glyphicon glyphicon glyphicon glyphicon-list-alt"></span>
					News
				</h3>
			</div>
			<div class="panel-body">
				<div id="news">
					...
					<script type="text/javascript">
						document
								.write('\x3Cscript type="text/javascript" src="'
					...
					<script type="text/javascript">
						(function() {
							var params = {
								rssmikle_url : "http://feeds.bbci.co.uk/news/rss.xml",
					...
					<div style="font-size: 10px; text-align: center;">
						<a href="http://feed.mikle.com/" target="_blank"
							style="color: #CCCCCC;">RSS Feed Widget</a>
